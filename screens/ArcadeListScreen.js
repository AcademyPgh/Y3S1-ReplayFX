    ...
    return (
      ...
      <ScrollView horizontal={true}>
        ...
        <View style={{
          ...
          <ScrollView>
            <TouchableHighlight onPress={() => {this.showGameDetails(1)}}>
              <View style={{borderTopWidth: StyleSheet.hairlineWidth}}><Text style={styles.item1}>My Touchable Game</Text></View>
            </TouchableHighlight>

            { gameList.filter(game => { return game.gameTitle == this.state.searchFilter }).map(game => {
              return (
